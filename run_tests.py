...
# runner.run(unittest.TestSuite((unittest.makeSuite(LoadCSVTests)))) #need to do
runner.run(unittest.TestSuite((unittest.makeSuite(FindMinTests))))  #need to do
runner.run(unittest.TestSuite((unittest.makeSuite(FindMaxTests)))) #need to do
